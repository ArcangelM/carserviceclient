...
@Component({
  selector: 'app-owner-edition',
  templateUrl: './owner-edition.component.html',
  styleUrls: ['./owner-edition.component.css']
})
export class OwnerEditionComponent implements OnInit {
  owner: any = {};
  constructor(
